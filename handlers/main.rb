VOTE_TYPES = {
  ...
  "stop_violations" => {"machine_vote_yes" => "Machine thinks the car stopped at the sign", "machine_vote_no" => "Machine thinks the car did not stop at the sign", "vote_type" => "Car Stop Violation", "vote_negative" => "No Stop", "vote_affirmative" => "Yes Stop", "vote_text" => "Is a car present in this GIF *and* is it blowing the stop sign? Press J if there isn't, K if there is (or just click the links below)"},
